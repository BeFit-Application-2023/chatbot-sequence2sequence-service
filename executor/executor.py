...
class TaskExecutorManager:
    def __init__(self, config : "ConfigManager", model) -> None:
        '''
        ...
        self.sequence2sequence_model = model
    ...
    def execute(self) -> None:
        ...
        while True:
            ...
            if self.priority_queue.qsize() > 0:
                ...
                pred = self.sequence2sequence_model.predict(task.text)

                # Adding the predicted sequence to the task.
